 ...
 * @author Double
 */
public class AlunosPorTurma extends javax.swing.JInternalFrame {
    ...
    public AlunosPorTurma() {
     ...
     public AlunosPorTurma(int idTurma) {
        initComponents();
        this.setBorder(javax.swing.BorderFactory.createEmptyBorder(0, 0, 0, 0));
        BasicInternalFrameUI ui = (BasicInternalFrameUI) this.getUI();
        ui.setNorthPane(null);
...
//ArrayList<TurmaModel> TurmaData = TurmaController.listaTodasTurma();
        ...
        ArrayList<RendimentoEscolar> RendimentoData = RendimentoEscolarController.getRedimentoByProfessor(usuarioLogado);
    ...
    private void initComponents() {
        ...
        jspNotaTrabalho.setModel(new javax.swing.SpinnerNumberModel(0, 0, 10, 1));

        jLabel3.setText("Nota");

        jspSelecionarProva.setModel(new javax.swing.SpinnerNumberModel(1, 1, 4, 1));
    ...
    private void btnSubmitTrabalhoActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnSubmitTrabalhoActionPerformed
        ...
        if (jtbRendimento.getSelectedRow() != -1) {
            ...
            //Pegar sppiner value
            int valueEntrega = (int) jspSelecionarTrabalho.getValue();

            //Variaveis 
            int valueTrabalhos = (int) jspSelecionarTrabalho.getValue();
            int valueNotaTrabalhos = (int) jspNotaTrabalho.getValue();
